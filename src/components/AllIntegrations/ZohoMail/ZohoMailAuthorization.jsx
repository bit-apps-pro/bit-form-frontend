...
export default function ZohoMailAuthorization({
  mailConf, setMailConf, step, setstep, isLoading, setisLoading, setSnackbar, redirectLocation, isInfo, authorizedAction,
}) {
    ...
    <>
      ...
      <div className="btcd-stp-page" style={{ width: 900, height: `${100}%` }}>
        ...
        <small className="d-blk mt-5">
          ...
          <a
            className="btcd-link"
            href={`https://api-console.zoho.${mailConf?.dataCenter || 'com'}/`}
            target="_blank"
            rel="noreferrer"
          >
            {__('Zoho API Console')}
        ...
        {!isInfo && (
          <>
            ...
            <AuthorizeBtn
              ...
              isLoading={isLoading}
              handleAuthorize={() => handleAuthorize(mailConf, setMailConf, setError, setisAuthorized, setisLoading, setSnackbar)}
            />
            <br />
