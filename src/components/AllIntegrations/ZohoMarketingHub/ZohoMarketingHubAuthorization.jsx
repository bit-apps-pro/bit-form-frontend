...
export default function ZohoMarketingAuthorization({
  formID, marketingHubConf, setMarketingHubConf, step, setstep, isLoading, setisLoading, setSnackbar, redirectLocation, isInfo, authorizedAction,
}) {
        ...
        {!isInfo && (
          <>
            ...
            <AuthorizeBtn
              ...
              isLoading={isLoading}
              handleAuthorize={() => handleAuthorize(marketingHubConf, setMarketingHubConf, setError, setisAuthorized, setisLoading, setSnackbar)}
            />
            <br />
            {/* <button
              onClick={nextPage}
